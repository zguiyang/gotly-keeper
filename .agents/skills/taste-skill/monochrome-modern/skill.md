---
name: design-taste-monochrome-modern
description: Senior UI/UX Engineer for strict black-white-gray interfaces with strong contrast-led hierarchy. Uses the full Taste Skill baseline but tunes the output for form, rhythm, typography, and motion without relying on color.
---

# High-Agency Monochrome Modern Frontend Skill
...
## 7. STYLE DIRECTION: Monochrome Modern

**When to use this skill:** Use this skill when the user wants a black-white-gray interface where hierarchy comes from form, contrast, rhythm, and composition rather than color.

### Core Identity
- Monochrome Modern should feel sharp, controlled, and stylish rather than unfinished.
- Without color, form and contrast must do the heavy lifting.
- The page should feel modern and dynamic through rhythm, type, and motion, not chroma.

### Palette and Material
- Stay in true black, white, and grayscale with no surprise color cast unless the prompt explicitly asks for one.
- Contrast must stay disciplined; do not hide behind muddy mid-grays.
- Links, focus, and state changes need non-color affordances.

### Typography Character
- Use strong typographic dramaturgy: scale, weight, tracking, and optical size replace color hierarchy.
- Great monochrome pages need stronger type, not neutral type.
- Use underlines, weight, inversion, and spacing to signal interaction and structure.

### Hero Direction
- Use one decisive contrast relationship: dark field vs light field, image crop vs type slab, or stark split.
- The first scene should feel complete and graphic.
- Avoid mid-tone mush and underpowered contrast.

### Navigation Direction
- Use thin monochrome rails, exact tabs, or minimal structural top bars with clear interaction states.
- Links need underline, inversion, or another strong signal.
- Avoid colorful indicators and weak gray-on-gray active states.

### Layout Tendencies
- Use contrast fields, rules, editorial splits, and structural negative space.
- Break the grid deliberately but rationally so the page does not become sterile.
- Lines, surfaces, and spacing act like the color system.

### Component Vocabulary
- Good fits: contrast band, ruled quote strip, grayscale gallery rail, mono comparison band, type block plus image crop, table-like rows.
- Weak fits: gray card floods, surprise accent bursts, soft blur haze, muddy imagery.

### Media and Imagery
- Use grayscale or naturally restrained imagery with strong composition.
- Black-and-white photography or carefully desaturated imagery should add texture and weight.
- Avoid weak low-contrast photos with no focal point.

### Motion Profile
- Use motion as rhythm and life signal: precise reveals, underline travel, list build-up, contrast shifts, subtle clip transitions.
- No playful bounce, no gimmick distortion unless the concept explicitly asks for experimental behavior.
- Reduced motion must still preserve clarity.

### Creative Arsenal For This Style
- Split-flap board transition.
- Scramble or decode text reveal used sparingly.
- Scroll progress reading bar or per-character spring reveal when typographically justified.

### Style-Specific Avoidances
- accidental blandness
- grayscale card walls
- surprise accent explosions
- soft blob wallpaper
- muddy low-contrast imagery
- generic default typography

### Copy Tone
- clean, direct, and taut
- few but intentional words
- avoid hyperbole
- let form carry part of the tone

### Current Production Priorities
- Keep the page in one dominant mode per output, light or dark, unless the user explicitly asks for inversion moments.
- Include monochrome imagery, editorial photography, interface stills, or diagrams by default so the page has visual weight.
- Add motion through sharp fades, contrast-based hover changes, section reveals, and controlled media transitions.
- Push creativity through crop, scale, rhythm, and composition rather than switching themes mid-page.
...
- For this style, start with the `Monochrome Modern` section in `../components/style-recipes.md`.
- Strong first picks: GSAP `text-masking` / `velocity-skew`, Aceternity `background-lines`, and React Bits `scroll-reveal` / `glare-hover`.
...
- Would this still feel strong without any accent color?
- Is form doing enough work?
- Did contrast create hierarchy instead of monotony?
- Would one screenshot feel recognizably monochrome-modern?
