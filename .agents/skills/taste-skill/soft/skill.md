---
name: design-taste-soft
description: Senior UI/UX Engineer for tactile, atmospheric, layered premium interfaces. Uses the full Taste Skill baseline but tunes the output for softness through material depth, not generic blob aesthetics.
---
...
- Weak fits: enterprise admin tables, harsh technical dividers, plain pricing grids, textureless filler sections.

### Media and Imagery
- Use blurred photography, masked product imagery, abstract material forms, subtle film stills, and curated atmospheric support.
- Background atmosphere should help, not dominate.
- Images need real direction, not placeholder softness.

### Motion Profile
- Use weighted spring motion, gentle depth response, icon drift, panel lift, and calm overlays with choreography.
- No childish bounce, syrupy goo motion, or constant floating loops.
- If it looks good only because of the gradient, the composition is weak.

### Creative Arsenal For This Style
- Spotlight border card.
- Directional hover-aware button.
- Lens blur depth or fluid smoke button only when it truly fits the concept.

### Style-Specific Avoidances
- default glassmorphism
- identical rounded cards everywhere
- giant glowy blobs as the main idea
- cheap luxury chrome
- cute iconography
- dense enterprise framing

### Copy Tone
- polished, calm, and specific
- premium without melodrama
- human but not bubbly
- avoid trendy startup filler

### Current Production Priorities
- Add gentle motion by default: fade-ins, drift, hover lift, soft highlight shifts, and tactile button presses.
- Include warm or tactile imagery, illustrations, or product stills more often so the softness feels embodied.
- Keep sections breathable and approachable while avoiding plain generic cards.
- Navigation should feel softer and more welcoming than a default text row.
...
- For this style, start with the `Soft` section in `../components/style-recipes.md`.
- Strong first picks: React Bits `fade-content` / `gradual-blur`, Aceternity `animated-testimonials` / `images-slider`, and gentle GSAP section reveals.
...
- Does softness still preserve hierarchy?
- Is there a real focal object or image?
- Did the page avoid becoming blur wallpaper?
- Would it still feel premium in grayscale?
