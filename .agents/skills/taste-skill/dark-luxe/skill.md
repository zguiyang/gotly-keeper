---
name: design-taste-dark-luxe
description: Senior UI/UX Engineer for atmospheric dark luxury interfaces. Uses the full Taste Skill baseline but tunes the output for material-rich darkness, light control, and premium restraint without neon or gamer drift.
---

# High-Agency Dark Luxe Frontend Skill
...
## 7. STYLE DIRECTION: Dark Luxe

**When to use this skill:** Use this skill when the user wants premium dark, atmospheric, cinematic, material-rich design without neon or gamer aesthetics.

### Core Identity
- Dark Luxe should feel like controlled light hitting expensive material in a showroom.
- Premium comes from shadow, composition, texture, and highlight control rather than glow gimmicks.
- Darkness must clarify focus, not hide weak layout.

### Palette and Material
- Use near-black with temperature, stepped dark surfaces, off-white text, and one luminous accent family.
- Hairlines can be bright but transparent; edges should feel expensive, not loud.
- No neon gamer glow, purple AI fog, or cheap glossy black gradients.

### Typography Character
- Use elegant sans or refined display faces with tight hierarchy and optically corrected weights on dark backgrounds.
- Do not let typography become overexposed or billboard-heavy.
- Weight, spacing, and contrast should feel precise and calm.

### Hero Direction
- Use a bounded dark stage with one focal light source or one dominant object mass.
- The hero should feel like a room, a vitrine, or a stage, not a blank dark void.
- A single highlight plane is stronger than many competing glints.

### Navigation Direction
- Use slim dark rails, understated top bars, and exact quiet utilities.
- Navigation should sit inside the stage without stealing focus.
- Avoid chunky bright nav containers and product-SaaS chrome.

### Layout Tendencies
- Use stage composition, material bands, dark gallery splits, and luminous detail rails.
- Depth should come from tone, overlap, edges, and controlled highlights more than from drop shadows.
- Large dark surfaces need one clear reason to exist.

### Component Vocabulary
- Good fits: spotlit object stage, material closeup band, dark comparison plate, luminous testimonial strip, spec reveal rail.
- Weak fits: glass cards floating in darkness, generic dashboard modules, neon pills, gaming widgets.

### Media and Imagery
- Use cinematic photography, renders, macro product shots, and architectural darkness.
- Images need real contrast discipline.
- Avoid generic nightlife stock, vague glow backgrounds, and muddy dark photography.

### Motion Profile
- Use slow fades, mask reveals, spotlight shifts, controlled parallax, and weighted hover states.
- Motion should feel filmic and expensive, not playful or sci-fi noisy.
- If a motion effect becomes more memorable than the composition, it is too much.

### Creative Arsenal For This Style
- Specular sweep on edge-lit objects.
- Clip-path reveal transition or luminous material band.
- Subtle shader-backed light field only if central to the concept.

### Style-Specific Avoidances
- neon gamer glow
- purple AI haze
- glass cards everywhere
- cheap glossy gradients
- ambient orb wallpaper
- overwrought sci-fi chrome

### Copy Tone
- confident and concise
- less perfume-ad fluff, more clear confidence
- let imagery carry part of the drama
- few, stronger phrases

### Current Production Priorities
- Large luxe imagery, texture plates, or campaign-style photography should appear in the hero or first two sections by default.
- Motion should be restrained but present: slow fades, reveal masks, hover sheen, soft depth shifts, and refined button response.
- Keep the page in one dominant mode per output and avoid awkward light-dark switching.
- Navigation should feel curated and premium, not like a plain utility bar.
...
- For this style, start with the `Dark Luxe` section in `../components/style-recipes.md`.
- Strong first picks: GSAP `text-masking`, Aceternity `hero-highlight` / `lamp-effect`, and React Bits `metallic-paint` / `glare-hover`.
...
- Does darkness clarify rather than obscure?
- Is the focal light source obvious?
- Did you avoid neon AI clich̩s?
- Would this still feel premium without motion?
