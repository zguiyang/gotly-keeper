---
name: design-taste-quiet-luxury
description: Senior UI/UX Engineer for quiet luxury and restrained premium interfaces. Uses the full Taste Skill baseline but tunes the output for material calm, subtle status, and hospitality-grade control.
---

# High-Agency Quiet Luxury Frontend Skill
...
## 7. STYLE DIRECTION: Quiet Luxury

**When to use this skill:** Use this skill when the user wants subtle status, quiet luxury, hospitality calm, material restraint, or premium understatement.

### Core Identity
- Quiet Luxury is status through restraint, not through logos, ornament, or theatrical luxury cues.
- It should feel expensive because it is controlled, not because it is loud.
- Quality should read through spacing, typography, materials, and image curation.

### Palette and Material
- Use off-whites, creams, linen, stone, espresso, muted sage, clay, and low-chroma earthy accents.
- Warm neutrals should feel material-led rather than decorative.
- No gold gradients, marble wallpaper, glossy black perfume stages, or fake aristocratic signals.

### Typography Character
- Use refined serif and sans pairings or one very polished sans system with calm hierarchy.
- Tracking, spacing, and proportion should create quiet authority.
- Copy should never sound salesy or eager.

### Hero Direction
- Use an arrival scene: interior, object, material plate, or composed hospitality-style split.
- The first screen should feel like stepping into a room or service world.
- Let the hero breathe, but keep it structurally complete.

### Navigation Direction
- Use slim hotel-grade rails, discreet top bars, or quiet section indices.
- Navigation should almost disappear until needed.
- Avoid novelty menus, chunky pills, or app chrome.

### Layout Tendencies
- Use service sequences, quote slabs, material strips, object pedestals, and paired interior plates.
- Fewer, larger decisions are better than many decorative ones.
- Whitespace should feel intentional rather than empty.

### Component Vocabulary
- Good fits: product rail, quote slab, calm uppercase nav, material strip, service card with restraint, paired object plate.
- Weak fits: feature-card floods, KPI dashboards, loud badges, chunky CTA bars.

### Media and Imagery
- Use interiors, material details, still lifes, architectural crops, and composed product imagery.
- Images should feel lit, curated, and calm.
- Avoid stock luxury clich̩s and generic penthouse glam.

### Motion Profile
- Motion should be minimal, quiet, and expensive-feeling: soft fades, subtle mask shifts, restrained hover refinement.
- No flashy reveals, loud scroll scenes, or spring-heavy theatrics.
- Motion should feel like finish quality, not a spectacle layer.

### Creative Arsenal For This Style
- Specular sweep used sparingly on a CTA or object edge.
- Glass refraction only if truly material and subtle, never generic glassmorphism.
- Morphing modal or quiet spotlight hover only when the concept earns it.

### Style-Specific Avoidances
- gold gradient clich̩s
- marble textures as shortcut
- glossy black hero stages
- oversized CTA theatrics
- card-heavy layouts
- fake aristocratic copy

### Copy Tone
- restrained, exact, and composed
- status through vocabulary, not hype
- short deliberate lines
- avoid urgency and startup clich̩s

### Current Production Priorities
- Make luxury more creative through crop, typography, material, and editorial imagery instead of plain beige emptiness.
- Add refined motion: slow fades, mask reveals, hover luminance shifts, and calm button glides.
- Use larger campaign-style images by default so the page carries emotional weight.
- Navigation should remain understated but deliberately premium.
...
- For this style, start with the `Quiet Luxury` section in `../components/style-recipes.md`.
- Strong first picks: GSAP mask/scroll demos, Aceternity `hero-highlight`, and React Bits `metallic-paint` / `shape-blur`.
...
- Does the page feel expensive without trying to prove it?
- Are materials doing real work?
- Did restraint stay intentional rather than empty?
- Would it still feel premium without any accent color?
