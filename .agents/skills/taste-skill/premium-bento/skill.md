---
name: design-taste-premium-bento
description: Senior UI/UX Engineer for premium modular bento layouts that avoid generic dashboard walls. Uses the full Taste Skill baseline but tunes the output for curated module rhythm, image-backed utility, and memorable product composition.
---
...
- Weak fits: twelve equal tiles, icon-title-copy repetition, rainbow category coding, cloned dashboard cards.
...
- Is there a real hierarchy among modules?
- Does at least one module feel memorable?
- Does the grid tell a story instead of filling space?
- Would this still feel premium if the shadows were reduced?
