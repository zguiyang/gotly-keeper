---
name: design-taste-minimalism
description: Senior UI/UX Engineer for restrained, document-like, premium minimal interfaces. Uses the full Taste Skill baseline but tunes layout, typography, imagery, and motion for calm, exact, low-noise output.
---

# High-Agency Minimalism Frontend Skill
...
* MOTION_INTENSITY: 2 (1=Static/No movement, 10=Cinematic/Magic Physics)
...
## 7. STYLE DIRECTION: Minimalism

**When to use this skill:** Use this skill when the user wants calm, restrained, document-like, literate, utilitarian, or quietly premium design.

### Core Identity
- Minimalism here should feel deliberate, edited, and expensive, not empty.
- Typography, framing, and proportion should do most of the work.
- Whitespace is structure, not absence.
- The page should still feel designed if the borders disappear.

### Palette and Material
- Default to paper, bone, chalk, ash, warm gray, off-black, and matte mineral neutrals.
- Accent color should be rare and small: active state, tiny icon, one rule, one emphasized datum.
- Gradients, glossy surfaces, chrome, and glass are banned unless the user explicitly demands them.
- Light mode is the safe default; dark only when clearly asked or clearly more appropriate.

### Typography Character
- Use a refined serif-plus-sans pairing for editorial or premium work, or a restrained sans system for software-adjacent minimalism.
- Headlines should feel trimmed and exact, not bloated or slogan-heavy.
- Body copy should read like edited prose, not a launch page.
- Metadata and tiny labels can use mono sparingly to add document utility.

### Hero Direction
- Build one calm focal scene: statement block, object plate, document field, or diagram.
- The first scene should often be a restrained split, framed slab, or quiet object-and-copy composition.
- If copy is short, increase the role of crop, paper framing, or one precise visual anchor.

### Navigation Direction
- Use a typographic top rail, a quiet section index, or a slim utility strip.
- Navigation should support the page, not headline it.
- Avoid chunky nav bars, giant CTA pills, and app-like chrome.

### Layout Tendencies
- Favor long vertical rhythm, narrow reading measures, disciplined offsets, and one idea per section.
- Use ruled rows, essay-plus-object splits, numbered principles, framed quotes, comparison tables, and captioned image plates.
- Avoid repeating the same card shell; dividers and spacing usually work better here.

### Component Vocabulary
- Good fits: numbered editorial lists, command clusters, quiet FAQ rows, faux desktop window framing, ruled comparison tables.
- Weak fits: loud carousels, oversized testimonial cards, pill-heavy dashboards, blur-driven wrappers.

### Media and Imagery
- Use object photography, restrained UI crops, diagrams, plans, and material closeups.
- One strong image should feel like a thesis, not filler.
- Avoid generic lifestyle stock and decorative blobs.

### Motion Profile
- Motion should be almost invisible until noticed: quiet reveals, subtle hover tightening, small underline or divider movement.
- No perpetual floating loops, giant parallax, or theatrical scroll scenes.
- If motion becomes the first thing the user notices, it is too loud.

### Creative Arsenal For This Style
- Windowed preview framed like a document plate.
- Accordion image slider only if kept quiet and editorial.
- Paragraph highlight reveal for reading rhythm.
...
- bright accent sections that break the calm
- fake luxury styling

### Copy Tone
- short, exact, declarative
- quiet confidence over hype
- few adjectives, stronger nouns
- let silence do work

### Current Production Priorities
- Include a hero image, object shot, spatial scene, or other strong visual anchor by default.
- Add minimal motion only: fades, slight translate, hover opacity shifts, and tactile button presses.
- Preserve clean spacing and single-idea sections instead of ultra-flat text stacks.
- Navigation should be sparse but still feel designed.
...
- For this style, start with the `Minimalism` section in `../components/style-recipes.md`.
- Strong first picks: GSAP restrained text/entry demos, React Bits `split-text` / `blur-text`, and quiet Aceternity line/highlight modules.
...
- Would this still feel designed if the borders disappeared?
- Does at least one image or object carry real weight?
- Did cards stay secondary to framing and spacing?
- Does the page feel calm rather than merely under-designed?
