---
name: design-taste-warm-modern
description: Senior UI/UX Engineer for warm, human, approachable modern interfaces with premium quality. Uses the full Taste Skill baseline but tunes the output for human-scaled hierarchy, material warmth, and clear, friendly polish.
---

# High-Agency Warm Modern Frontend Skill
...
## 7. STYLE DIRECTION: Warm Modern

**When to use this skill:** Use this skill when the user wants modern but human, warm but premium, approachable yet still carefully designed interfaces.

### Core Identity
- Warm Modern should feel sunlit, human, and composed.
- It sits between cool minimalism and soft lifestyle tech: approachable without becoming childish, premium without becoming cold.
- Warmth should come from light, material, pacing, and specific human signals.

### Palette and Material
- Use cream, sand, clay, oat, parchment, walnut, warm stone, brick, sage, or deep teal in disciplined roles.
- Avoid startup beige mush with no hierarchy.
- Warm neutrals still need strong contrast and clear CTA logic.

### Typography Character
- Use a friendly sans for UI plus a warming serif when the page benefits from editorial voice.
- Keep hierarchy clear and human-scaled.
- Avoid cold sterile defaults and empty softness.

### Hero Direction
- Use a warm split hero with copy plus one strong visual anchor such as product, person, object, or space.
- The first screen should feel welcoming but complete.
- Preserve one clear scene even if copy is short.

### Navigation Direction
- Use clear human-scaled navigation with restrained rounding or subtle segmentation.
- Keep nav easy to parse and secondary to the main scene.
- Avoid novelty menus and stiff institutional rails.

### Layout Tendencies
- Use process rails, paired image-and-quote sections, warm comparison bands, object shelves, and gently asymmetric splits.
- Warmth should not mean clutter.
- At least one section should feel like a room or interaction, not a card stack.

### Component Vocabulary
- Good fits: human split layouts, warm proof bands, craft-led imagery, soft cards with discipline, testimonial woven into layout.
- Weak fits: hard industrial systems, sterile admin tables, cute onboarding clich̩s, endless beige boxes.

### Media and Imagery
- Use photography with light, material, human presence, or care.
- Images should add trust and life, not just friendliness.
- Avoid empty stock-smile grids and weak lifestyle filler.

### Motion Profile
- Use calm slide-ins, tactile button feedback, subtle hover compression, and occasional light-driven transitions.
- Motion should feel personable and polished, not performative.
- Avoid gimmicky physics and endless loops.

### Creative Arsenal For This Style
- Waveform avatar or voice-reactive element if the product is conversational.
- Directional press ripple or magnetic proximity button used subtly.
- Warm progress or chapter indicator integrated into the story.

### Style-Specific Avoidances
- generic beige SaaS
- cute consumer-app clich̩s
- over-rounded card floods
- stock-happy people overload
- neon accents
- cold sterile minimalism

### Copy Tone
- clear, warm, and grounded
- human without being chatty
- avoid hype and fake intimacy
- use specific reassuring language

### Current Production Priorities
- Add warmer motion: fade, slide, card lift, button press, image reveal, and quiet stagger where appropriate.
- Include lifestyle, editorial, or product imagery more reliably so the page feels alive.
- Keep the warmth in materials, crops, and transitions rather than flattening into generic clean UI.
- Navigation should feel friendlier and more bespoke than a standard top bar.
...
- For this style, start with the `Warm Modern` section in `../components/style-recipes.md`.
- Strong first picks: GSAP `trigger-on-scroll`, Aceternity `animated-testimonials` / `images-slider`, and React Bits `fade-content` / `count-up`.
...
- Does warmth come from material and pacing instead of clich̩?
- Is there enough visual humanity?
- Did the page stay premium instead of cute?
- Would the page still work without testimonials propping it up?
