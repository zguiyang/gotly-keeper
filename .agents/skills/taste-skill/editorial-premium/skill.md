---
name: design-taste-editorial-premium
description: Senior UI/UX Engineer for image-led design-journal, architecture-magazine, and cultured editorial interfaces. Uses the full Taste Skill baseline but tunes the output for publication pacing, refined typography, and image-first hierarchy.
---

# High-Agency Editorial Premium Frontend Skill
...
## 7. STYLE DIRECTION: Editorial Premium

**When to use this skill:** Use this skill when the user wants design-journal, architecture-magazine, furniture-editorial, or cultured longform publication design.

### Core Identity
- This style should feel like a European design publication translated to the web.
- Premium comes from proportion, image sequencing, typography, and restraint, not from luxury clich̩s.
- The page should read like a designed article, not a content-marketing page.

### Palette and Material
- Use paper whites, warm stone neutrals, softened charcoal, and one muted editorial accent such as brick, terracotta, or coral.
- Most visible color should come from photography, not from UI fills.
- Stay in light mode by default; this style wants daylight and paper.

### Typography Character
- Use a refined serif for display and a disciplined sans for body, metadata, and navigation.
- The title should feel literary, not fashion-poster severe.
- Body measure should stay around 58 to 66ch with generous but controlled leading.

### Hero Direction
- The first image should usually arrive before or with the title, not after it.
- Open with a large image plate, then a split article lead with title on one side and dek or framing copy on the other.
- The first two sections should feel like one curated sequence.

### Navigation Direction
- Use a slim masthead, taxonomy rail, publication index, or quiet section anchors.
- Navigation should feel like publication chrome rather than product UI.
- Share, bookmark, and utilities must stay tiny and subordinate.

### Layout Tendencies
- Use publication rail, hero image plate, taxonomy line, split article lead, longform body, image interruption, and related-story twins.
- Avoid fake editorial sidebars, pale decorative slabs, centered blog-post templates, or card-based article flows.
- Asymmetry should be deliberate: 4/8 or 5/7 splits are stronger than 6/6.

### Component Vocabulary
- Good fits: taxonomy rail, split lead, side note, margin quote, paired image plate, previous/next twins.
- Weak fits: giant CTA bars, product-marketing blocks, heavy sticky nav, feature-card footers.

### Media and Imagery
- Use interiors, objects, architecture, material details, and bright clear photography.
- Let images create atmosphere and rhythm breaks.
- Avoid generic stock-team photos, blobs, and decorative SVG doodles.

### Motion Profile
- Motion should stay near-silent: underline drifts, gentle fades, tiny image parallax, quiet related-story movement.
- No kinetic typography, pinned scroll spectacle, or ornamental loops.
- Reading rhythm always wins over motion.

### Creative Arsenal For This Style
- Caption rail tied to large plates.
- Chapter-based progress bar for longform reading.
- Paragraph highlight reveal used sparingly in essays.

### Style-Specific Avoidances
- gold gradients
- glossy black stages
- glassmorphism
- decorative sidebars with no content job
- deep red accents everywhere
- CTA banners between paragraphs

### Copy Tone
- cultured, exact, and restrained
- headline as title, not ad slogan
- body should read like edited prose
- avoid startup verbs and inspiration clich̩s

### Current Production Priorities
- Add elegant motion by default: hero fade, staged image appearance, link underline motion, and restrained section reveals.
- Keep imagery reliable and editorial: large figure blocks, documentary crops, or art-directed stills where appropriate.
- Navigation should feel magazine-like, archival, or salon-like rather than purely functional.
...
- For this style, start with the `Editorial Premium` section in `../components/style-recipes.md`.
- Strong first picks: GSAP `animate-text` / `text-masking`, React Bits `split-text` / `scroll-reveal`, and Aceternity image-led modules.
...
- Does the first image establish the page atmosphere?
- Does the title feel literary instead of promotional?
- Is whitespace structural instead of empty?
- Would a design editor take this seriously?
