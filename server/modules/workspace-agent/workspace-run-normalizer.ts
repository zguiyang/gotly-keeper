...
const TIME_HINT_REGEX =
  new RegExp(
    `([0-9一二三四五六七八九十两]+)(分钟|小时|天)后|(今天|明天|后天)(上午|中午|下午|晚上|凌晨)?${HOUR_TEXT}[点时](?:半|[0-9一二三四五六七八九十两]+分)?|(今天|明天|后天)(上午|中午|下午|晚上|凌晨)|(这周末|本周末|下周末)|((?:下周|本周|这周|周)[一二三四五六日天](?:下班前|午饭前))|(下个月[0-9一二三四五六七八九十两]+[日号]?)|((?:下周|本周|这周)[一二三四五六日天]?|周[一二三四五六日天])(上午|中午|下午|晚上|凌晨)?${HOUR_TEXT}?[点时]?(?:半|[0-9一二三四五六七八九十两]+分)?|(今晚|明早)|[0-9一二三四五六七八九十两]+月[0-9一二三四五六七八九十两]+[日号]?(上午|中午|下午|晚上|凌晨)?${HOUR_TEXT}?[点时]?(?:半|[0-9一二三四五六七八九十两]+分)?`,
    'g'
  )
